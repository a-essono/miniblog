<x-app-layout>
    ...
    <div class="py-6 max-w-5xl mx-auto space-y-4">
        ...
        @endif
        <!-- vérifie que l'utilisateur actuel dispose de l'autorisation passée en paramèt -->
        @can('posts.create')
                        ...
                        <tr class="border-t">
                            ...
                            <td class="px-4 py-2 space-x-2">
                                @can('update', $post)
                                    ...
                                    class="underline text-indigo-600">Éditer</a>
                                @endcan
                                ...
                                @if ($post->status === 'published')
                                    ...
                                    class="underline text-gray-700" target="blank" rel="noopener">Voir en public ↗</a>
                                @endif
